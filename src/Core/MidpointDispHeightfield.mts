import { calcNextPowerOfTwo, randomFloatRange } from "../Extras/Utils.mjs";
import type { int, float } from "../Extras/Types.mjs";
import Heightfield from "./Heightfield.mjs";

export default class MidpointDispHeightfield extends Heightfield {
