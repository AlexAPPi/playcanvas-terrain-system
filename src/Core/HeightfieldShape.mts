import { float, int, IVector3, RefObject } from "../Extras/Types.mjs";
import { IReadonlyAbsShatteredHeightMap } from "./AbsShatteredHeightMap.mjs";
import { IZone } from "./IZone.mjs";
import HeightfieldRaycastResult from "./HeightfieldRaycastResult.mjs";
import Triangle from "./Triangle.mjs";

// Our system is divided into a general part and an engine part,
// for optimization we use the engine part in this file. (playcanvas Vec3, Mat4, Tri, BoundingBox)
...
export default class HeightfieldShape {
    ...
    constructor(heightMap: IReadonlyAbsShatteredHeightMap) {
    ...
    protected _triangleIntersectsRay(tri: Triangle, ray: pcx.Ray, bestResult: HeightfieldRaycastResult): boolean {
    ...
    protected _quadAction(rs: IGridRaycastState, ray: pcx.Ray, result: HeightfieldRaycastResult): boolean {
    ...
    private _intersectsRay(localRay: pcx.Ray, result: HeightfieldRaycastResult = new HeightfieldRaycastResult()): boolean {
    ...
    public intersectsRay(worldTranform: pcx.Mat4 | null | undefined, ray: pcx.Ray, result: HeightfieldRaycastResult = new HeightfieldRaycastResult()): boolean {
