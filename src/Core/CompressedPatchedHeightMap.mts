...
export class CompressedPatchedHeightMap<TTCompressAlgoritm extends TCompressAlgoritm>
     extends AbsChunkedHeightMap<THeightMapArrayTypeBag<TTCompressAlgoritm>>
  implements IReadonlyAbsChunkedHeightMapTypped<THeightMapArrayTypeBag<TTCompressAlgoritm>> {
    ...
    public static createBuffer<TCompress extends TCompressAlgoritm>(width: int, depth: int, chunkSize: int, algoritm: TCompress): THeightMapArrayTypeBag<TCompress> {
    ...
    public constructor(width: int, depth: int, patchSize: int, dataChunkSize: int, maxHeight: float, algoritm: TTCompressAlgoritm);
    public constructor(width: int, depth: int, patchSize: int, dataChunkSize: int, maxHeight: float, algoritm: TTCompressAlgoritm, buffer: THeightMapArrayTypeBag<TTCompressAlgoritm>, itemSize?: int, itemHeightIndexOffset?: int);
    public constructor(width: int, depth: int, patchSize: int, dataChunkSize: int, maxHeight: float, algoritm: TTCompressAlgoritm, buffer?: THeightMapArrayTypeBag<TTCompressAlgoritm>, itemSize: int = defaultHeightVertexSize, itemHeightIndexOffset: int = 0) {
    ...
    public override getChunkBuffer(type: any, chunkX: int, chunkZ: int): any {
    ...
    public override getChunksBuffers(type: any): any {
