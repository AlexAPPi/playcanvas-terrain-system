...
export interface IGridBox extends IGeomipGrid {
    readonly minHeight: float;
    readonly maxHeight: float;
}

export class GeomipGridBuilder {
    ...
    public get width() { return this.heightMap.width; }
    public get depth() { return this.heightMap.depth; }
    public get patchSize() { return this._heightMap.patchSize; }
    public get numPatchesX() { return this._heightMap.numPatchesX; }
    public get numPatchesZ() { return this._heightMap.numPatchesZ; }
    ...
    constructor(heightMap: RefObject<AbsPatchedHeightMap<any>>, zFar: float) {
        ...
        const patchSize = heightMap.patchSize;
        ...
        this._vertices  = new CoordsBuffer(this._heightMap, patchSize);
        this._vertices.init();
        this._buildLodsAndIndices(zFar, this._heightMap.patchSize, this._heightMap.numPatchesX, this._heightMap.numPatchesZ);
    }
