export default Ammo;
export function Ammo<T>(target?: T): Promise<T & typeof Ammo>;
...
type btContactAddedCallback = (world: btDynamicsWorld, ) => void;
type btContactDestroyedCallback = (world: btDynamicsWorld, ) => void;
type btContactProcessedCallback = (world: btDynamicsWorld, ) => void;
...
export function addFunction(cb: btContactAddedCallback, v: typeof CONTACT_ADDED_CALLBACK_SIGNATURE): number;
export function addFunction(cb: btContactDestroyedCallback, v: typeof CONTACT_DESTROYED_CALLBACK_SIGNATURE): number;
export function addFunction(cb: btContactProcessedCallback, v: typeof CONTACT_PROCESSED_CALLBACK_SIGNATURE): number;
...
export class AllHitsConvexResultCallback extends ConvexResultCallback {
    constructor(from: btVector3, to: btVector3);
    get_m_hitCollisionObject(): btCollisionObject;
    get_m_hitCollisionObjects(): btConstCollisionObjectArray;
    set_m_hitCollisionObjects(m_hitCollisionObjects: btConstCollisionObjectArray): void;
    get_m_convexFromWorld(): btVector3;
    get_m_convexFromWorld(m_convexFromWorld: btVector3): void;
    get_m_convexToWorld(): btVector3;
    set_m_convexToWorld(m_convexToWorld: btVector3): void;
    get_m_hitNormalWorld(): btVector3Array;
    set_m_hitNormalWorld(m_hitNormalWorld: btVector3Array): void;
...
export class btDynamicsWorld extends btCollisionWorld {
    ...
    setInternalTickCallback(funcpointer: number, worldUserInfo?: unknown, isPreTick?: boolean): void;
}
...
export class ConcreteActionInterface {
    constructor();
    updateAction(collisionWorld: btCollisionWorld, deltaTimeStep: number): void;
...
export interface OverlapResultCallback {
    addSingleResult(cp: btManifoldPoint): number;
}

export class ConcreteOverlapResultCallback {
    constructor();
    addSingleResult(cp: btManifoldPoint): number;
}

export class btPhysicsResolver {
    constructor();
    overlap(ghostObject: btPairCachingGhostObject, collisionWorld: btCollisionWorld, resultCallback: OverlapResultCallback): void;
}
